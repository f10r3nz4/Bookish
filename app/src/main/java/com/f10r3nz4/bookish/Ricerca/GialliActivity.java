...
public class GialliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
          ...
          /*FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Giallo"), Book.class)
                        .build();*/
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Giallo");
        FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
