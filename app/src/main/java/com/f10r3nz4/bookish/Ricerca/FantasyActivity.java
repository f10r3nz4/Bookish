    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Fantasy"), Book.class)
                        .build();*/
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Fantasy");
        FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
