...
public class ClassiciActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Classici"), Book.class)
                        .build();*/
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Classici");
        FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
