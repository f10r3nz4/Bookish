    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Narrativa"), Book.class)
                        .build();*/
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Libri").orderByChild("genere").equalTo("Narrativa");
        FirebaseRecyclerOptions<Book> options =
                new FirebaseRecyclerOptions.Builder<Book>()
